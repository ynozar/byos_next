    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground max-w-prose">
          Explore and test screens in both their direct rendering and bitmap rendering forms.
          This examples page is designed to help develop and test react components for your TRMNL device.
          Copy the folder of any of these examples and update screens.json with the correct details, and use edit device to assign the screen to your device.
        </p>
      </div>

      <Suspense fallback={<div className="w-full text-center">Loading components...</div>}>
        <ComponentsGrid />
      </Suspense>
    </div>
  );
