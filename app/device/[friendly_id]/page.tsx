        ...
        <div className="max-w-6xl mx-auto p-4 md:p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div className="flex items-center gap-2">
                    <h2 className="mt-10 scroll-m-20 pb-0 text-3xl font-semibold tracking-tight transition-colors first:mt-0 text-box">{device.name}</h2>
                    <Badge className={`text-xs h-[1lh] px-1 text-foreground ${device.status === "online" ? "bg-green-500" : "bg-red-500"}`}>
                        {device.status}
                    </Badge>
                </div>
                <div className="flex items-center gap-2">
